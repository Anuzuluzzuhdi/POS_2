...
class UserController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($users)
            ...
            ->addColumn('aksi', function ($user) {  // menambahkan kolom aksi 
                ...
                $btn = '<button style="margin-right: 5px;" onclick= "modalAction(\'' . url('/user/' . $user->user_id . '/show_ajax') . '\')" class ="btn btn-info btn-sm" >Detail</button> ';
                $btn .= '<button style="margin-right: 5px;" onclick= "modalAction(\'' . url('/user/' . $user->user_id . '/edit_ajax') . '\')" class ="btn btn-warning btn-sm">Edit</button> ';
    ...
    public function update(Request $request, string $id)
    {
        ...
        UserModel::find($id)->update([
            'username' => $request->username,
            'nama' => $request->nama,
            'password' => $request->filled('password') ? bcrypt($request->password) : UserModel::findOrFail($id)->password,
            'level_id' => $request->level_id,
        ]);
